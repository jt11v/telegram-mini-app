...
// node_modules/lottie-colorify/lib/index.js
var require_lib = __commonJS({
  "node_modules/lottie-colorify/lib/index.js"(exports) {
    ...
    var convertColorToLottieColor = function(color) {
      if (typeof color === "string" && color.match(/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i)) {
        ...
        return [
          Math.round(parseInt(result[1], 16) / 255 * 1e3) / 1e3,
          Math.round(parseInt(result[2], 16) / 255 * 1e3) / 1e3,
          Math.round(parseInt(result[3], 16) / 255 * 1e3) / 1e3
        ];
      } else if (typeof color === "object" && color.length === 3 && color.every(function(item) {
        return item >= 0 && item <= 255;
      })) {
        return [
          Math.round(color[0] / 255 * 1e3) / 1e3,
          Math.round(color[1] / 255 * 1e3) / 1e3,
          Math.round(color[2] / 255 * 1e3) / 1e3
        ];
      } else if (!color) {
        return void 0;
      } else {
    ...
    exports.replaceColor = function(sourceColor, targetColor, lottieObj) {
      ...
      function doReplace(sourceLottieColor, targetLottieColor, obj) {
        if (obj.s && Array.isArray(obj.s) && obj.s.length === 4) {
          ...
          } else if (sourceLottieColor[0] === round(obj.c.k[0]) && sourceLottieColor[1] === round(obj.c.k[1]) && sourceLottieColor[2] === round(obj.c.k[2])) {
...
//# sourceMappingURL=lottie-colorify.js.map
